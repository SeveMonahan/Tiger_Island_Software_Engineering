...
public class NetworkServerTest {
    ...
    public static void sendMessagesOnCommand(PrintWriter out, BufferedReader stdIn) throws IOException {
        String[] messages = {
                ...
                "GAME A MOVE 0 PLAYER 3 PLACED ROCK+JUNGLE AT 1 1 -2 6 FOUNDED SETTLEMENT AT 1 2 -3",
                "MAKE YOUR MOVE IN GAME A WITHIN 1.5 SECONDS: MOVE 1 PLACE JUNGLE+JUNGLE"
        };
