...
public class MoveInGameIncoming {
    ...
    public MoveInGameIncoming(String gid, String moveID, String pid, TileMove tileMove, ConstructionMoveTransmission constructionMoveTransmission){
        this.gid = gid;
        this.moveID = moveID;
        this.pid = pid;
